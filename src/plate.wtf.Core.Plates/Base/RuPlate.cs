...
namespace plate.wtf.Core.Plates
{
    public class RuPlate : IRuPlate
    {
        ...
        public Plate Parse(string plate)
        {
            ...
            {
                plateReturn.Info = ParseStandard1993Plate(plate);
        ...
        private static PlateInfo ParseStandard1993Plate(string plate)
        {
            ...
            Enums.PlateFormat plateFormat = Enums.PlateFormat.Ru_Standard1993;
